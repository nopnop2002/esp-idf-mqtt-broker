...
- esp-idf V4.4  
 ...
 __If MDNS_STRICT_MODE is not specified, mDNS name resolution will not be possible after long-term operation.__   
- esp-idf V4.4.1   
 mDNS component has been updated.   
 If you set CONFIG_MDNS_STRICT_MODE = y in sdkconfig.defaults, the firmware will be built with MDNS_STRICT_MODE.   
 __Even if MDNS_STRICT_MODE is specified, mDNS name resolution will not be possible after long-term operation.__   
